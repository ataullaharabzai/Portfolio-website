  ...
  return (
    <main className="p-5 md:p-15 mt-5">
      <div>
        ...
        <p
          data-aos="fade-left"
          className="text-[#4e525a] dark:text-gray-300 text-[16px] md:text-[24px] mt-5"
        >
        ...
        <p
          data-aos="fade-left"
          className="text-[#4e525a] dark:text-gray-300 text-[16px] md:text-[24px]"
        >
      ...
      <section className="projects p-5">
        <div data-aos="fade-up" className="project1 mt-10 bg-white rounded-2xl dark:bg-gray-800 p-3">
          ...
          <p className="md:text-[22px] dark:text-gray-300 text-[#4e525a]">
        ...
        <div data-aos="fade-up" className="project2 mt-10 dark:bg-gray-800 p-3 bg-white rounded-2xl">
          ...
          <p className="md:text-[22px] text-[#4e525a] dark:text-gray-300">
