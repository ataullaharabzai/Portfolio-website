    ...
    <main>
      <section className='title p-5 md:p-15 mt-5'>
        <div className='w-full'>
          <p className='text-4xl font-semibold md:font-bold md:text-8xl'>About me<span className='font-bold text-3xl md:text-8xl text-[#6e06f2]'>.</span></p>
          <p className='md:text-2xl text-[#4e525a] mt-5 sm:border-l-20 border-[#6e06f2] p-3'>Developing beautiful and functional websites is what I love doing, which is why I put my full effort into every project I work on. I enjoy solving problems, learning new technologies, and creating experiences that are both useful and enjoyable for users.</p>
        </div>
      </section>
