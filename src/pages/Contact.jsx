      ...
      <div className='w-full p-5 md:p-15 mt-10 flex flex-col md:flex-row justify-around'>
        <section className='introduction w-full md:max-w-[50%] flex flex-wrap justify-center items-stretch flex-col gap-2'>
          <div className='leading-12 w-full md:w1/2 lg:leading-24'>
            <h1 className='text-[30px] lg:text-[60px] font-bold'>Get In Touch<span className='text-[#6e06f2] text-3xl sm:text-8xl'>.</span></h1>
          </div>
          <p className='text-[14px] md:text-[22px] text-[#4e525a] md:leading-8 leading-6'>Have a project in mind<span className='text-[#6e06f2]'>?</span></p>
          <p className='text-[14px] md:text-[22px] text-[#4e525a] md:leading-8 leading-6'>Let’s connect through the form and I’ll get back to you shortly.</p>
