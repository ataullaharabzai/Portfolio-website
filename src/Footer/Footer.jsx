...
function Footer() {
  return (
    <footer className="p-5 md:p-10 bg-gray-200 dark:bg-gray-800">
      <div className="w-full flex flex-col md:flex-row gap-5 md:gap-0 justify-between items-center flex-wrap">
        <div className="w-full max-w-[320px] flex justify-center gap-5 md:gap-0 md:justify-between items-center text-[#4e525a] dark:text-gray-300 text-[11px] sm:text-[17px]">
          <NavLink
            to="/"
            className={({ isActive }) =>
              isActive
        ...
        <div className="text-[#4e525a] dark:text-gray-300 w-full max-w-[120px] flex justify-around items-center">
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center md:mt-10 mt-5 gap-5 md:gap-0">
        <div className="flex justify-center items-center sm:items-start flex-col gap-2">
          ...
          <div className="text-[14px] md:text-[16px] w-full lg:w-[320px] flex justify-center lg:justify-start items-center mt-5 gap-4 lg:gap-2 sm:mt-0">
            <NavLink
              to="/contact"
              className="border border-[#6c06f2] dark:hover:bg-orange-700 dark:bg-orange-600 dark:border-orange-600 rounded-lg font-medium px-2.5 py-2 text-white bg-[#6c06f2] cursor-pointer hover:bg-[#6c06f2c5] transition-all"
            >
              Get In Touch
            </NavLink>
            <NavLink
